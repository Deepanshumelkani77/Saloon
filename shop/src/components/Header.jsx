        ...
        {slides.map((slide, index) => (
          <div key={index} className="min-w-full h-full relative">
            ...
            <div className="absolute inset-0 flex items-center justify-start px-4 sm:px-6 md:px-12 lg:px-20">
              <div className="max-w-xs sm:max-w-md md:max-w-lg lg:max-w-2xl text-white z-10">
                {/* Animated Title */}
                <h1 
                ...
                {/* Animated Subtitle */}
                <h2 
                  className={`text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold mb-4 sm:mb-6 transition-all duration-1000 delay-200 leading-tight ${
                    currentSlide === index ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                  }`}
                >
                  {slide.subtitle}
                ...
                <p 
                  className={`text-sm sm:text-base md:text-lg lg:text-xl text-gray-300 mb-6 sm:mb-8 leading-relaxed transition-all duration-1000 delay-400 px-1 sm:px-0 ${
                    currentSlide === index ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                  }`}
                >
                  {slide.description}
                ...
                >
                  <button 
                    className="px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-[#D9C27B] to-[#F4E4A6] text-black font-bold rounded-full hover:shadow-2xl hover:scale-105 transition-all duration-300 text-sm sm:text-base lg:text-lg"
                  >
                    Shop Now
                  </button>
                  <button 
                    className="px-6 sm:px-8 py-3 sm:py-4 border-2 border-[#D9C27B] text-[#D9C27B] font-bold rounded-full hover:bg-[#D9C27B] hover:text-black transition-all duration-300 text-sm sm:text-base lg:text-lg"
                  >
                    Learn More
                  </button>
                </div>
