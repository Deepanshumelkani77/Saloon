...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-[#23211b] to-[#181818] flex items-center justify-center p-4">
      <div className="bg-black/95 backdrop-blur-xl border border-[#D9C27B]/30 rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
        {/* Header */}
        <div className="text-center py-8 px-6 border-b border-[#D9C27B]/20 relative">
          <button
            onClick={goBack}
            className="absolute top-4 left-4 text-gray-400 hover:text-[#D9C27B] transition-colors text-xl"
          >
            <FaArrowLeft />
          </button>
          ...
          <p className="text-gray-400 text-sm">
            {isSignup 
              ? 'Join us to shop premium salon products' 
              : 'Login to access your shop account'
            }
          </p>
        </div>
