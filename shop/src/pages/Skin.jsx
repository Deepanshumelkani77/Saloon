  ...
  const fetchSkinProducts = async () => {
    try {
      ...
      if (response.data.success) {
        ...
        setError('Failed to fetch skin products');
      }
    } catch (err) {
      console.error('Error fetching skin products:', err);
      setError('Failed to load skin products');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-20 pt-8 pb-4">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
            Discover our professional-grade skin care collection. From nourishing moisturizers to protective sunscreens, 
            <span className="text-[#D9C27B] font-semibold"> transform your skin</span> with salon-quality products.
          </p>
        </div>
        ...
        <div className="relative max-w-2xl mx-auto mb-8">
          ...
          <div className="relative bg-gray-800/60 backdrop-blur-sm border border-[#D9C27B]/40 rounded-2xl overflow-hidden">
            ...
            <input
              type="text"
              placeholder="Search premium skin products..."
              value={searchTerm}
            ...
            <div className="relative">
              ...
              <div className="relative bg-gray-800/60 backdrop-blur-sm border border-[#D9C27B]/40 rounded-2xl overflow-hidden">
                ...
                >
                  ...
                  <option value="Moisturisers" className="bg-gray-800 text-white">💧 Moisturisers</option>
                  <option value="Cleansers" className="bg-gray-800 text-white">🧼 Cleansers</option>
                  <option value="Suncare & Spf" className="bg-gray-800 text-white">☀️ Suncare & Spf</option>
                  <option value="Eyecare & Creams" className="bg-gray-800 text-white">👁️ Eyecare & Creams</option>
                  <option value="Face Serums" className="bg-gray-800 text-white">🧴 Face Serums</option>
                  <option value="Face & Sheet Masks" className="bg-gray-800 text-white">🎭 Face & Sheet Masks</option>
                  <option value="Toners" className="bg-gray-800 text-white">💦 Toners</option>
                  <option value="Face Oils" className="bg-gray-800 text-white">🌿 Face Oils</option>
                </select>
            ...
            <div className="sticky top-8">
              <div className="bg-black border-2 border-[#D9C27B]/30 rounded-3xl p-6 shadow-2xl">
                ...
                <div className="text-center mb-6">
                  ...
                  <p className="text-gray-300 text-sm">Filter by skin care type</p>
                </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-3 md:gap-4 lg:gap-5 xl:gap-6">
                {filteredProducts.map((product, index) => (
                  ...
                  >
                    ...
                    <div className="p-3 md:p-4 lg:p-4 xl:p-5 space-y-2 md:space-y-31lg:space-y-1 xl:space-y-1">
