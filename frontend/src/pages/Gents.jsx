        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div
                key={index}
                className="group bg-black rounded-3xl p-6 shadow-2xl hover:shadow-[#D9C27B]/20 transition-all duration-500 border border-[#D9C27B]/20 hover:border-[#D9C27B]/60 backdrop-blur-sm hover:scale-105 hover:-translate-y-2 relative overflow-hidden"
              >
                {/* Service Header */}
