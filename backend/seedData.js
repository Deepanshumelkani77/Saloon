...
const services = [
  ...
  { name: 'Men\'s Hi-Lites', price: 200, duration: 120, category: 'Men\'s Hair' },
  ...
  { name: 'Men\'s Hair Straightening', price: 500, duration: 180, category: 'Men\'s Treatments' },
  { name: 'Men\'s Hair Smoothening', price: 200, duration: 150, category: 'Men\'s Treatments' },
  ...
  // Women's Hair Color
  { name: 'Global Hair Coloring', price: 500, duration: 120, category: 'Women\'s Color' },
  { name: 'Root Touch Up', price: 800, duration: 90, category: 'Women\'s Color' },
  
  // Women's Hair Treatments
  { name: 'Hair Rebonding', price: 1000, duration: 240, category: 'Women\'s Treatments' },
  { name: 'Hair Perming', price: 2000, duration: 180, category: 'Women\'s Treatments' },
  { name: 'Keratin Treatment', price: 500, duration: 200, category: 'Women\'s Treatments' },
  { name: 'Hair Smoothening', price: 800, duration: 180, category: 'Women\'s Treatments' },
  { name: 'Hair Spa Treatment', price: 1000, duration: 90, category: 'Women\'s Treatments' },
  { name: 'Hair Volumizing', price: 200, duration: 120, category: 'Women\'s Treatments' },
  { name: 'Color Protection Treatment', price: 800, duration: 60, category: 'Women\'s Treatments' },
  
  // Women's Makeup
  { name: 'Party Make Up', price: 500, duration: 90, category: 'Women\'s Makeup' },
  { name: 'Engagement Make Up', price: 500, duration: 120, category: 'Women\'s Makeup' },
  { name: 'Bridal & Reception Make Up', price: 1000, duration: 180, category: 'Women\'s Makeup' },
  ...
  { name: 'Luxury Facials/Rituals', price: 200, duration: 75, category: 'Women\'s Skincare' },
  { name: 'Women\'s Clean Up', price: 500, duration: 45, category: 'Women\'s Skincare' },
  { name: 'Body Polishing/Rejuvenation', price: 500, duration: 120, category: 'Women\'s Skincare' },
  ...
  { name: 'Spa Pedicure', price: 2000, duration: 75, category: 'Women\'s Nails' },
