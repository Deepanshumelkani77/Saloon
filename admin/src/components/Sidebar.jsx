    ...
    <>
      ...
      `}>
        ...
        <div className="p-4 border-t border-[#D9C27B]/20">
        {
          ...
          <button className="w-full flex items-center justify-center gap-3 px-4 py-3.5 bg-[#D9C27B] text-black font-bold rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 transform hover:from-[#F4E4A6] hover:via-[#D9C27B] hover:to-[#F4E4A6] group">
