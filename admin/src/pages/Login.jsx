...
const Login = () => {
 ...
 const { openLogin, setOpenLogin, initialMode, setInitialMode, admin, token } = useContext(AppContext);
...
const handleGoogleLogin = () => {
  ...
  // Close modal handler - only allow closing if admin is logged in
  const handleClose = () => {
    if (admin && token) {
      setOpenLogin(false);
    }
          ...
          <div className="mt-6">
            ...
            <div className="mt-4">
              <button 
                ...
                type="button"
                className="w-full flex items-center justify-center px-4 py-3 border border-[#D9C27B]/30 rounded-lg bg-gray-900/50 hover:bg-[#D9C27B]/10 hover:border-[#D9C27B] transition-all duration-200 shadow-md hover:shadow-lg group"
              >
                ...
                <span className="text-white font-medium group-hover:text-[#D9C27B] transition-colors">
