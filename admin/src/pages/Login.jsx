          ...
          <div className="mt-6">
            ...
            <div className="mt-4">
              <button onClick={handleGoogleLogin}
                type="button"
                className="w-full flex items-center justify-center px-4 py-3 border border-gray-700 rounded-lg bg-gray-900/50 text-white hover:bg-gray-800/50 transition-all"
              >
